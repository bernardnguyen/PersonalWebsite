...
addParagraph(coffee, 'The house we were renting in Oregon was unfurnished. This was very new to me, as a college student where all my previous dwellings had a bed, dresser, and desk included. As someone planning to move to New York in a year, I decided to buy the cheapest furniture possible, which included a shelf/dresser made of cinder blocks and some smooth MDF boards. Our living room, however, was really nice. I had installed a ceiling-mounted projector with a tablecloth screen and a nice bluetooth speaker setup. Our couch was comfortable, but fairly small for four roommates. We were in desparate need of a footrest/coffee table, so I went to Home Depot and made one out of a couple 2x4s and a pack of outdoor balusters.');
...
addParagraph(research, 'Pulsating stars usually oscillate fairly regularly with a single fundamental frequency, but rarely oscillate with two different fundamental frequencies (and linear combinations of those two). The star that Dr. Watkins was studying oscillated with at least THREE different fundamental frequencies. My task was to use his data and Fourier transforms to try and find a fourth fundamental frequency, which would have made the star the first discovery of its kind. Using Fourier transforms, I wrote an algorithm to determine whether each new frequency was a fundamental frequency, or simply a linear combination of known fundamental frequencies. Unfortunately I found that the star only oscillated with the three known fundamental frequencies, but working with Dr. Watkins was still a fun and educational experience to end my Willamette career.');
...
addParagraph(run, 'Part of the Codesmith Summer Academy of Code was using everything we learned in the first four days, and using the final three days to build a final project. Because Codesmith emphasized pair programming as a learning tool, we also did the final project with a partner. My partner, Caitlin Westerfield, is an avid runner and frequently uses a website called "mapmyrun". We decided to make a similar application, which would help us practice implementing the Google Maps API.');
...
addParagraph(connect, 'In my final semester at Willamette University, I took a machine learning class. One of the projects during that class was to make a game against a computer that would get better as we played. One of my upcoming projects is to combine that project and practice my web-development by making a machine learning connect 4 web app.');
addParagraph(connect, 'My goal is to have a user play against the machine that will slowly get better. Users can choose to play against the "master", or a new bot who they can train on their own. I\'ll update this page when the website is complete.');
