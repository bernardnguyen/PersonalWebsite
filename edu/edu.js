...
addParagraph(wilDets, 'After high school, I decided to attend Willamette University in order to participate in their 3-2 engineering program. Several engineering schools offer students from small liberal arts colleges a chance to earn a second degree in engineering that wouldn\'t have been possible otherwise. I declared my major in physics by my second year, and added on minors in computer science and mathematics later on.');
addParagraph(wilDets, 'One of my favorite classes offered by Willamette\'s physics department was cosmology. Though the math behind tensor equations were difficult and frustrating, the concepts regarding general relativity, black holes, and the big bang were incredibly fascinating. Another class I really enjoyed was machine learning. My professor incorporated a lot of game theory into the course, making labs and assignments particularly fun. In my third year, I took a lab-centered course called Advanced Techniques in Experimental Physics (ATEP). This was by far my favorite course, where 3-week units were split into exploring and experimenting with the research being conducted by the department\'s various professors. Some topics included biological physics, optics, electronics, and cosmology. Though exploring different fields of physics was fascinating, I had already set my mind on pursuing electrical engineering.');
addParagraph(wilDets, 'If I had to choose the Willamette experience that impacted my life the most, it was my employment with the IT department, WITS. I\'d argue that more of my time was spent in the WITS offices than class: working, helping out, or even just hanging out. Originally I took the job wanting to learn a valuable life skill: how to fix a computer. After a couple shifts, however, I started to realize how much I loved learning new skills on the job. I enjoyed going to work every day, not only because of the new skills to be learned or the exciting problems to be solved throughout the day, but also because I genuinely enjoyed spending time with the people I worked with. It was my experience with WITS that solidified not only my desire to work with technology in the future, but also my desire to work as a part of a team, solving problems bigger than myself.');
